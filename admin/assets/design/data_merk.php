      ...
      <div class="flex-1 h-full relative ">
        ...
        <!-- Content -->
          <div class="w-full flex">
            <div class="w-80 h-60 bg-gray-200 rounded-md shadow-md">
              <p class="pl-2 pt-8 pb-3">Nama Merk</p>
              <div class="pl-2">
                <input type="text" name="" class="bg-gray-300 pl-2" placeholder="ketik...">
              </div>
              <div class="flex py-20">
                <button type="button" class="bg-green-500 w-1/2 h-6 mx-1 rounded-lg">Send</button>
                <button type="button" class="bg-red-500 w-1/2 h-6 mx-1 rounded-lg">Reset</button>
              </div>
            </div>
          </div>
            </div>
