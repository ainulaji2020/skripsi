            ...
            <tbody>
              ...
              ?>
                <tr class="text-xs p-5">
                  ...
                  <td class="py-2 px-5"><img src="../../assets/images/gallery/<?php echo $row['gambar'] ?>" width="100" height="100"></td>
                  <td class="py-2" style="width: 100px;">
                    <div class="w-full flex justify-center items-start">
                      <div class="w-1/3 px-1">
                        <a href="form.php?aksi=edit&id=<?php echo $row['id_gambar']?>" class="px-2 py-1 bg-blue-400 rounded">
                          <i class="fa fa-pencil"></i>
                        </a>
                      </div>
                      <div class="w-1/3 px-1">
                        <a href="?aksi=delete&id=<?php echo $row['id_gambar'];?>" class="px-2 py-1 bg-red-600 rounded">
              ...
              <?php $no++ ; } } ?>
              <?php if (isset($data['gambar']) && count($data['gambar']) < 1) { ?>
