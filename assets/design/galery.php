...
<body>
	...
	<div class="container mx-auto flex ">
		<div class="w-3/4 mx-auto flex flex-wrap">
			...
			<div class="px-4 py-4 w-2/6 ">
				<img class="w-full bg-center rounded-lg h-80" src="../images/picture-3.jpg">
			</div>
			<div class="px-4 py-4 w-2/6 ">
			...
			<div class="px-4 py-4 w-2/6 ">
				<img class="w-full bg-center rounded-lg h-80" src="../images/gambar7.jpg">
			</div>
			<div class="px-4 py-4 w-2/6 ">
				<img class="w-full bg-center rounded-lg h-80" src="../images/gambar8.jpg">
			</div>
			<div class="px-4 py-4 w-2/6 ">
				<img class="w-full bg-center rounded-lg h-80" src="../images/gambar9.jpg">
			</div>
			<div class="px-4 py-4 w-2/6 ">
				<img class="w-full bg-center rounded-lg h-80" src="../images/gambar10.jpg">
			</div>
			<div class="px-4 py-4 w-2/6 ">
				<img class="w-full bg-center rounded-lg h-80" src="../images/gambar11.jpg">
			</div>
			<div class="px-4 py-4 w-2/6 ">
				<img class="w-full bg-center rounded-lg h-80" src="../images/gambar12.jpg">
			</div>
			<div class="px-4 py-4 w-2/6 ">
				<img class="w-full bg-center rounded-lg h-80" src="../images/gambar13.jpg">
			</div>
			<div class="px-4 py-4 w-2/6 ">
				<img class="w-full bg-center rounded-lg h-80" src="../images/gambar14.jpg">
			</div>
			<div class="px-4 py-4 w-2/6 ">
				<img class="w-full bg-center rounded-lg h-80" src="../images/gambar15.jpg">
			</div>
			<div class="px-4 py-4 w-2/6 ">
				<img class="w-full bg-center rounded-lg h-80" src="../images/gambar16.jpg">
			</div>
			<div class="px-4 py-4 w-2/6 ">
				<img class="w-full bg-center rounded-lg h-80" src="../images/gambar17.jpg">
			</div>
			<div class="px-4 py-4 w-2/6 ">
				<img class="w-full bg-center rounded-lg h-80" src="../images/gambar18.jpg">
			</div>
			<div class="px-4 py-4 w-2/6 ">
				<img class="w-full bg-center rounded-lg h-80" src="../images/gambar19.jpg">
			</div>
		</div>
	</div>
	<!-- fotter -->
