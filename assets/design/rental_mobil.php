...
<body>
	...
	<p class="py-6 text-center text-xl">Silahkan Pilih Mobil-Mobil Berkualitas Yang Kami Tawarkan Kepada Anda.<br/> Silahkan Tanyakan Harga.</p>
			...
			<div class="w-full flex flex-wrap h-auto rounded-md">
				<div class="w-full h-52 mb-10 relative">
					<div class="w-full h-full absolute">
						<img class="w-full h-full object-cover rounded-md" src="../images/honda-jazz.jpg" />
					</div>
				</div>
				<p class="mx-auto"><span class="text-yellow-400">Honda Jazz</span></p>
				<button class="mx-auto px-6 pb-8 border-b-8">
					...
					<a class="rounded-md border border-black px-4  transition duration-50 focus:outline-none font-semibold hover:bg-blue-500 hover:text-white text-xl cursor-pointer" href="detail_mobil.php">Detail</a>
				</button>
			</div>
		</div>
	</div>
