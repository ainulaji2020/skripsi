...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 22 Feb 2023 pada 13.00
...
--
-- Struktur dari tabel `tb_foto_mobil`
--
...
--
-- Dumping data untuk tabel `tb_foto_mobil`
--
...
--
-- Indeks untuk tabel `tb_foto_mobil`
--
...
--
-- AUTO_INCREMENT untuk tabel `tb_foto_mobil`
--
ALTER TABLE `tb_foto_mobil`
...
--
-- Ketidakleluasaan untuk tabel `tb_foto_mobil`
--
ALTER TABLE `tb_foto_mobil`
